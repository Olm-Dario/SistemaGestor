...
{
    public partial class FormReporteCompas : Form
    {
        public FormReporteCompas()
        {
            InitializeComponent();
        }

        private void FormReporteCompas_Load(object sender, EventArgs e)
        {
        ...
        private void btnBuscarResultado_Click(object sender, EventArgs e)
        {
            ...
            lista = new CapaNegocio_Reporte().Compra(
                    textFechaInicio.Value.ToString("dd/MM/yyyy"),
                    textFechaFin.Value.ToString("dd/MM/yyyy"),
                    idProveedor
                );
